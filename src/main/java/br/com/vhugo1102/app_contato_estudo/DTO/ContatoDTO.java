...
public class ContatoDTO {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY) // Ou outro tipo de geração dependendo do seu banco de dados
	private Long id;
	...
	public String toString() {
		return "ContatoDTO [id=" + id + ", tipoContato=" + tipoContato + ", contato=" + contato + ", idPessoa="
				+ idPessoa + "]";
	}
}
